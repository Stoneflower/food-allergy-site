  ...
  const createTableWithData = async () => {
    try {
      ...
      const allergyData = [
        ...
        { item_id: 'soybean', name: '大豆(soybean)', name_en: 'Soybean', category: 'recommended', icon: '🫘', description: '大豆、豆腐、味噌、醤油など', small_amount_safe: true, heated_safe: true, severity_level: 'medium' },
